...
ProceduralGeneration.Room.prototype.find_free_region = function (size_in_tiles) {
    ...
    do {
        ...
        center_tile = new Phaser.Point(this.game_state.game.rnd.between(4, (this.game_state.game.world.width / this.tile_dimensions.x) - 4),
            this.game_state.game.rnd.between(4, (this.game_state.game.world.height / this.tile_dimensions.y) - 4));
        region = [center_tile];
